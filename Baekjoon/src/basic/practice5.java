...
public class practice5 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// a층의 b호에 살고싶다면 자신의 아래(a-1)층의 1호에서 b호까지의 사람들의 수의 합만큼 사람들을 데려와 살아야한다.
		// 0층의 i호에는 i명이 산다.  => 즉, 3층의 3호에 살고 싶다면 2층의 1호에서 3호까지의 사람들의 수의 합만큼 살아야하고 1+2+3 = 6명의 사람을 데려와 살아야한다.
		
		// k = 살고싶은 층
		// n = 살고싶은 호
		// 데려와야 하는 사람의 수* c를 구하라 ! 
